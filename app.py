...
def index():
    ...
    if response.status_code == 200:
        ...
        photo9_data = blogs_data[8]
        photo10_data = blogs_data[9]
        ...
        return render_template('index.html', photo1_image=photo1_data.get('image'), photo1_type=photo1_data.get('type'),
                               ...
                               photo9_image=photo9_data.get('image'), photo9_headline=photo9_data.get('headline')[0:20] + "...", photo9_date=photo9_data.get('date'),
                               photo10_image=photo10_data.get('image'), photo10_headline=photo10_data.get('headline')[0:20] + "...", photo10_date=photo10_data.get('date'))
    else:
